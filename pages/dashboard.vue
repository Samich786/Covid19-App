        ...
        <a-row class="mx-5" :gutter="[10,10]">
            <a-col  :span="6">
                <a-card class="confirm">
                    <a-row>
                        <a-col :span="14"> <h3 class="font-size">Confirmed Casese </h3></a-col>
                        <a-col :span="10"> <img src="../static/diagnosed-cases.png" alt="" width="100%"></a-col>
                    </a-row>
                    <a-row type="flex" justify="center">
                        <a-col><h1 class="stat-font mb-0">{{ covidDetails.Totalcases}}</h1></a-col>
                    </a-row>
                </a-card>
            </a-col>
            <a-col  :span="6">
                <a-card class="deaths">
                    <a-row>
                        <a-col :span="14"> <h3 class="font-size">DEATHS </h3></a-col>
                        <a-col :span="10"> <img src="../static/deaths.png" alt="" width="100%"></a-col>
                    </a-row>
                    <a-row type="flex" justify="center">
                        <a-col><h1 class="stat-font mb-0">{{ covidDetails.Totaldeaths}}</h1></a-col>
                    </a-row>
                </a-card>
            </a-col>
            <a-col  :span="6">
                <a-card class="recovered">
                    <a-row>
                        <a-col :span="14"> <h3 class="font-size">Total Recovered </h3></a-col>
                        <a-col :span="10"> <img src="../static/recovered.png" alt="" width="100%"></a-col>
                    </a-row>
                    <a-row type="flex" justify="center">
                        <a-col><h1 class="stat-font mb-0">{{ covidDetails.Totalrecovered}}</h1></a-col>
                    </a-row>
                </a-card>
            </a-col>
            <a-col  :span="6">
                <a-card class="tests">
                    <a-row>
                        <a-col :span="14"> <h3 class="font-size">Total Tests </h3></a-col>
                        <a-col :span="10"> <img src="../static/active-cases.png" alt="" width="100%"></a-col>
                    </a-row>
                    <a-row type="flex" justify="center">
                        <a-col><h1 class="stat-font mb-0">{{ covidDetails.Totaltests}}</h1></a-col>
                    </a-row>
                </a-card>
            </a-col>
        </a-row>
        <a-row class="mx-5" :gutter="[10,10]">
            <a-col :span="6" :offset="9">
                <a-card class="critical">
                    <a-row>
                        <a-col :span="14"> <h3 class="font-size">Critical Casese </h3></a-col>
                        <a-col :span="10"> <img src="../static/critical.png" alt="" width="100%"></a-col>
                    </a-row>
                    <a-row type="flex" justify="center">
                        <a-col><h1 class="stat-font mb-0">{{ covidDetails.SeriousCritical}}</h1></a-col>
                    </a-row>
                </a-card>
            </a-col>
        </a-row>
